...
def prepare_model_pass_batch(
    ...
    for request_id, (model_id, request_data) in requests.items():
        ...
        for item in request_data.data:
            ...
            all_base_action_log_probs.append(loss_fn_inputs.base_action_log_probs.data)
            all_model_ids.append(model_id)
    ...
    return types.PreparedModelPassBatch(
        ...
        all_base_action_log_probs=all_base_action_log_probs,
        all_model_ids=all_model_ids,
...
class TinkerEngine:
    ...
    def process_pending_requests_once(self) -> None:
        ...
        # Training request payloads are no longer needed after completion.
